export const createPortfolioPrompt = `
    ...
    The portfolio should be a JSON object that matches the following interface,do not include any other text and make all the dates in a dates in a valid format":
