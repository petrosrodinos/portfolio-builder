...
const PortfolioTemplates = () => {
  ...
  const handleSelectTemplate = (templateId: string) => {
    if (templateId !== portfolio_theme) {
      ...
      confirmTemplateChange(templateId);
    }
  };
              ...
              <div className="mt-4 flex flex-col gap-2">
                ...
                >
                  ...
                  <span className="truncate">
                    {portfolio_theme === template.id ? "Selected" : "Select"}
                  </span>
                </Button>
                <Button
                  variant="outline"
      ...
      <AlertDialog open={!!templateToConfirm} onOpenChange={() => setTemplateToConfirm(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to change your portfolio template? This will update your
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              onClick={() => templateToConfirm && confirmTemplateChange(templateToConfirm)}
            >
